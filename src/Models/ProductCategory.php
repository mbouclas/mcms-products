...
class ProductCategory extends Model
{
     ...
     * @var string
     */
    protected $presenter = 'Mcms\Products\Presenters\ProductCategoryPresenter';
    ...
    public function __construct($attributes = [])
    {
        ...
        $this->config = Config::get('products.categories');
    ...
    {
        return $this->belongsToMany($this->productsModel);
    }
    ...
    private function countSubCategoryItems($parentId)
    {
        ...
        foreach ($tree as $item) {
            ...
            $sql[] = "(SELECT count(*) as total from product_product_category where product_category_id IN (".
                implode(',',$qm)
                .")) as c{$item['id']}";
        }
    ...
    public function newCollection(array $models = []){
        return new ProductCategoriesCollection($models);
    }
